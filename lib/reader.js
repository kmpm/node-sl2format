...
function Reader(options) {
  ...
  options = options || {};
  this.options = {
    feetToMeter: typeof options.feetToMeter === 'undefined' ? true : options.feetToMeter,
    radToDeg: typeof options.radToDeg === 'undefined' ? true : options.radToDeg,
    speedInUnit: typeof options.speedInUnit === 'string' && blocks.SPEED_UNITS.indexOf(options.speedInUnit) >= 0 ?
      options.speedInUnit : 'kn',
    convertProjection: typeof options.convertProjection === 'undefined' ? true : options.convertProjection
  };
  Transform.call(this, {
    objectMode: true
  });
